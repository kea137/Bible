...
const selectedSeriesId = ref<string | undefined>(
    props.lesson.series_id?.toString(),
);

watchEffect(() => {
    while (
        editableLesson.value.paragraphs.length <
        editableLesson.value.no_paragraphs
    ) {
                    ...
                    >
                        <CardHeader class="pb-3 sm:pb-6">
                            ...
                            <CardDescription class="text-xs sm:text-sm">{{
                                t('Edit Lesson by filling out the form below.')
                            }}</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Input
                                        ...
                                        :placeholder="t('Number of Paragraphs')"
                                    />
                                    <InputError
                                    ...
                                    <template v-if="createNewSeries">
                                        ...
                                        <div class="flex flex-col space-y-1.5">
                                            ...
                                            <Input
                                                ...
                                                name="episode_number"
                                                :placeholder="
                                                    editableLesson.episode_number?.toString() ||
                                                    '1'
                                                "
                                                :default-value="
                                                    editableLesson.episode_number?.toString()
