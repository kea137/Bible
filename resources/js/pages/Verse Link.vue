        ...
        <DialogContent class="sm:max-w-[425px]">
            <DialogHeader>
                ...
                <DialogDescription>
                    {{
                        t(
                            'Select the type of connection and add an optional label.',
                        )
                    }}
                </DialogDescription>
            </DialogHeader>
        ...
        <DialogContent class="sm:max-w-[425px]">
            ...
            <div class="py-4">
                <p class="text-sm text-muted-foreground">
                    {{
                        t(
                            'Click "Import" to create a new canvas with the data from the selected file.',
                        )
                    }}
                </p>
            </div>
